...
import { addMonthlyExpenseAPI } from "../service/api";
...
const Expenses = () => {
  ...
  async function addMonthlyExpense() {
    try {
      ...
      setIsLoading(false);
      Swal.fire("Monthly expense added", "The monthly expense was added successfully", "success");
      setOption("");
    } catch (err) {
        ...
        {option === "addNew" ? (
          <div className="table-container">
            ...
            <div className="button-group">
              ...
              <button
                onClick={() =>
                  setTableRows((prev) => [...prev, INITIAL_EXPENSE_ROW_DATA])
                }
                className="button button-primary-outline"
              >
                Add new row
